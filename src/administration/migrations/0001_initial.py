    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(validators=[django.core.validators.RegexValidator('^[\\w.@+-]+$',
                ...
                ('email_status', models.CharField(null=True, blank=True,
                                                  choices=[('Verified', 'Verified'), ('Pending', 'Pending'),
                                                           ('Incomplete', 'Incomplete')], max_length=24)),
                ('mobile', models.CharField(blank=True, null=True, max_length=20)),
                ('mobile_status', models.CharField(null=True, blank=True,
                                                   choices=[('Verified', 'Verified'), ('Pending', 'Pending'),
                                                            ('Incomplete', 'Incomplete')], max_length=24)),
                ('gender',
                 models.CharField(default='Male', choices=[('Female', 'Female'), ('Male', 'Male')], max_length=15)),
                ('birthday', models.DateField(blank=True, null=True)),
                ('language', models.CharField(null=True, blank=True, default='en',
                                              choices=[('af', 'Afrikaans'), ('ar', 'Arabic'), ('ast', 'Asturian'),
                                                       ...
                                                       ('zh-tw', 'Traditional Chinese')], max_length=7)),
                ('bio', models.TextField(blank=True)),
                ('profile_image',
                 models.ImageField(blank=True, null=True, upload_to=administration.models.get_one_profile_images_path)),
        ...
        migrations.CreateModel(
            name='CustomToken',
            fields=[
                ('token', models.CharField(serialize=False, max_length=255, primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ManyToManyField(blank=True, verbose_name='permissions', to='auth.Permission')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                verbose_name='groups', to='administration.GroupBasic', blank=True, related_query_name='user',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(help_text='Specific permissions for this user.',
                                         ...
                                         related_query_name='user', related_name='user_set'),
        ),
    ]
